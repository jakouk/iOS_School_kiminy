...
- (void)viewDidLoad {
    ...
    //NSUerDefaultsDidChangeNotification은 NSUser가 변경되면 방송을 때리고 didUseDefaultsChange메소드가 작동됨.
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didUserDefaultsChange:) name:NSUserDefaultsDidChangeNotification object:nil];
}

- (void)didUserDefaultsChange:(NSNotificationCenter *)noti {
